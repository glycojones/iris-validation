...
DISCRETE_METRICS = (
    {
        ...
        "seq_colors": (COLORS["RED"], COLORS["ORANGE"], COLORS["GREEN"]),
        "seq_labels": ("Outlier", "Allowed", "Favoured"),
        "is_covariance": False,
        "is_molprobity": False,
        "is_reflections": False,
        "is_rama_z": False,
    ...
    },
    {
        ...
        "ring_color": COLORS["L_GREY"],
        "seq_colors": (COLORS["RED"], COLORS["ORANGE"], COLORS["GREEN"]),
        "seq_labels": ("Multiple Clashes", "One Clash", "No Clashes"),
        "is_covariance": False,
        "is_molprobity": True,
        "is_reflections": False,
        "is_rama_z": False,
    ...
    },
    {
        ...
        "short_name": "CMO",
        "ring_color": COLORS["L_GREY"],
        "seq_colors": (COLORS["RED"], COLORS["GREEN"]),
        "seq_labels": ("Misaligned", "Aligned"),
        "is_covariance": True,
        "is_molprobity": False,
        "is_reflections": False,
        "is_rama_z": False,
...
RESIDUE_VIEW_BARS = [CONTINUOUS_METRICS[0], CONTINUOUS_METRICS[5]]
