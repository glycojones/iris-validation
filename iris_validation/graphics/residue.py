...
class ResidueView:
    ...
    def _draw(self):
        ...
        for box_id, box_title in enumerate(self.box_names):
            box_bounds = [
                0.25 * self.canvas_size[0] + left_indent,
            ...
            self.dwg.add(
                self.dwg.text(
                    "",
                    insert=(
                        (box_bounds[0] + box_bounds[2]) / 2,
                        (box_bounds[1] + box_bounds[3]) / 2,
                    ),
                    font_size=20,
                    font_family="Arial",
                    font_weight="bold",
            ...
            self.dwg.add(
                self.dwg.text(
                    box_title,
                    insert=(
                        left_indent + 0.125 * self.canvas_size[0],
                        (box_bounds[1] + box_bounds[3]) / 2,
                    ),
                    font_size=18,
                    font_family="Arial",
        ...
        self.dwg.add(
            self.dwg.polygon(
                points=[
                    (bar_charts_bounds[0], bar_charts_bounds[1]),
        ...
        for label_id in range(10 + 1):
            height = (
                bar_charts_bounds[1]
                + label_id * (bar_charts_bounds[3] - bar_charts_bounds[1]) / 10
            )
            self.dwg.add(
                self.dwg.line(
        ...
        for bar_id, bar_name in enumerate(self.bar_names):
            ...
            gradient = LinearGradient(
                start=(0, 0), end=(0, 1), id=f"{self.svg_id}-gradient-{bar_id}"
            )
