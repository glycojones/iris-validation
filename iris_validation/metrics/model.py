    ...
    def __init__(
        ...
        for mmol_chain in mmol_model:
            ...
            chain_covariance_data = (
                None if covariance_data is None else covariance_data[chain_id]
            )
            chain_molprobity_data = (
                None if molprobity_data is None else molprobity_data[chain_id]
            )
    ...
    def b_factor_lists(self):
        ...
        for chain in self.chains:
            (
                ...
                ligand_bfs_c,
                ion_bfs_c,
            ) = chain.b_factor_lists()
            for model_li, chain_li in zip(
                (
                    all_bfs,
                    aa_bfs,
                    mc_bfs,
